...
<1>2. ASSUME TypeOK, Inv,
             ...
             a(i) \/ b(i) \/ cs(i)
      PROVE  TypeOK'
    BY <1>2, IsaM("auto") DEF TypeOK, Inv, a, b, cs
...
THEOREM
  ...
  PROVE  TypeOK' /\ Inv'
  BY SMT DEF TypeOK, Inv, Next, ProcSet, p, vars, a, b, cs
----------------------------------------------------------------------
(***************************************************************************)
...
\* Last modified Sun Jan 03 23:02:16 CST 2021 by Administrator
\* Created Sun Jan 03 23:01:49 CST 2021 by Administrator
