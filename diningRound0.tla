...
(* \* Deadlock since all nodes are symmetric *)
...
****************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "4ed94ded" /\ chksum(tla) = "5673014f")
VARIABLES fork, pc
...
j(self) == J0(self) \/ H(self) \/ P(self) \/ E(self) \/ T(self) \/ R(self)
...
\* Last modified Sun Jan 03 11:31:34 CST 2021 by Administrator
\* Created Sun Jan 03 11:31:04 CST 2021 by Administrator
