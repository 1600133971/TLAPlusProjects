TwoPhase
  A specification of a very simple hardware protocol called 
  two-phase handshaking, and a theorem asserting that it
  implements the Alternate spec under a refinement mapping.  
  It contains a TLA+ proof of this theorem that has been 
  checked by the TLAPS proof system.
----------------------------- MODULE two_phase -----------------------------
(***************************************************************************)
...
\* Last modified Sat Jan 02 22:47:42 CST 2021 by Administrator
\* Created Sat Jan 02 22:43:25 CST 2021 by Administrator
