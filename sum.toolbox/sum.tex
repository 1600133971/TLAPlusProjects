...
\@x{}\moduleLeftDash\@xx{ {\MODULE} sum}\moduleRightDash\@xx{}%
 \@x{ {\EXTENDS} Naturals ,\, TLC ,\, FiniteSets ,\, Functions ,\,
 FiniteSetsExt}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{12.29} {\p@mmalgorithm} sum}%
 \@x{ {\p@variables} account \.{=} \{ 1 ,\, 2 ,\, 3 ,\, 4 ,\, 5 \} ,\, count
 \.{=} 0 {\p@semicolon}}%
\@x{ {\p@begin}}%
 \@x{\@s{16.4} A\@s{.5}\textrm{:}\@s{3}\@s{0.63} count \.{:=} Sum ( account )
 {\p@semicolon}}%
\@x{\@s{16.4} B\@s{.5}\textrm{:}\@s{3} {\p@print} count {\p@semicolon}}%
\@x{ {\p@end} {\p@algorithm}}%
\@y{}%
\@xx{}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{775fc70f}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{e3665052}'')
}%
\@xx{}%
\@x{ {\VARIABLES} account ,\, count ,\, pc}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} account ,\, count ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{37.72} \.{\land} account \.{=} \{ 1 ,\, 2 ,\, 3 ,\, 4 ,\, 5 \}}%
\@x{\@s{37.72} \.{\land} count \.{=} 0}%
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{A}}%
\@pvspace{8.0pt}%
\@x{ A\@s{0.63} \.{\defeq} \.{\land} pc \.{=}\@w{A}}%
\@x{\@s{26.95} \.{\land} count \.{'} \.{=} Sum ( account )}%
\@x{\@s{26.95} \.{\land} pc \.{'} \.{=}\@w{B}}%
\@x{\@s{26.95} \.{\land} {\UNCHANGED} account}%
\@pvspace{8.0pt}%
\@x{ B \.{\defeq} \.{\land} pc \.{=}\@w{B}}%
\@x{\@s{26.95} \.{\land} PrintT ( count )}%
\@x{\@s{26.95} \.{\land} pc \.{'} \.{=}\@w{Done}}%
\@x{\@s{26.95} \.{\land} {\UNCHANGED} {\langle} account ,\, count {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Terminating \.{\defeq} pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} A \.{\lor} B}%
\@x{\@s{51.36} \.{\lor} Terminating}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 19:44:20 \ensuremath{CST} 2020 by Administrator
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Dec} 01
 21:46:10 \ensuremath{CST} 2020 by Administrator
\end{cpar}%
\end{lcom}%
\end{document}
