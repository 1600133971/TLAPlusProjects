...
GCD(p, q) == Maximum(Divisors(p) \cup Divisors(q))
Number == Nat \ {0}
...
<1>2 Spec => []InductiveInvariant (* we should use propositional temporal logic(PTL) prover (LS4), should extends TLAPS *)
...
\* Last modified Tue Dec 29 23:44:39 CST 2020 by Administrator
\* Last modified Sun Jun 07 15:40:57 JST 2020 by shanada
\* Created Sat Jun 06 16:45:37 JST 2020 by shanada
