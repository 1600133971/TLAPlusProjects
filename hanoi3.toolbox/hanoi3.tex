...
\@x{}\moduleLeftDash\@xx{ {\MODULE} hanoi3}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} TLC ,\, Sequences ,\, Integers}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{12.29} {\p@mmalgorithm} hanoi3}%
 \@x{ {\p@variables} tower \.{=} {\langle} {\langle} 1 ,\, 2 ,\, 3 {\rangle}
 ,\, {\langle} {\rangle} ,\, {\langle} {\rangle} {\rangle} ,\,}%
\@pvspace{8.0pt}%
\@x{ {\p@define}}%
\@x{\@s{8.2} D \.{\defeq} {\DOMAIN} tower}%
\@x{ {\p@end} {\p@define} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@begin}}%
\@x{ {\p@while} {\TRUE} {\p@do}}%
 \@x{\@s{8.2} {\p@assert} tower [ 3 ] \.{\neq} {\langle} 1 ,\, 2 ,\, 3
 {\rangle} {\p@semicolon}}%
 \@x{\@s{8.2} {\p@with} from \.{\in} \{ x \.{\in} D \.{:} tower [ x ] \.{\neq}
 {\langle} {\rangle} \} ,\,}%
\@x{\@s{34.39} to \.{\in} \{}%
\@x{\@s{64.99} y \.{\in} D \.{:}}%
\@x{\@s{70.73} \.{\lor} tower [ y ] \.{=} {\langle} {\rangle}}%
\@x{\@s{70.73} \.{\lor} Head ( tower [ from ] ) \.{<} Head ( tower [ y ] )}%
\@x{\@s{56.79} \}}%
\@x{\@s{8.2} {\p@do}}%
\@x{\@s{16.4} tower [ from ] \.{:=} Tail ( tower [ from ] ) \.{\p@barbar}}%
 \@x{\@s{16.4} tower [ to ] \.{:=} {\langle} Head ( tower [ from ] ) {\rangle}
 \.{\circ} tower [ to ] {\p@semicolon}}%
\@x{\@s{8.2} {\p@end} {\p@with} {\p@semicolon}}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{1a2110da}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{19c39e85}'')
}%
\@xx{}%
\@x{ {\VARIABLE} tower}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{ D \.{\defeq} {\DOMAIN} tower}%
\@pvspace{16.0pt}%
\@x{ vars\@s{2.10} \.{\defeq} {\langle} tower {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{4.12} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
 \@x{\@s{39.83} \.{\land} tower \.{=} {\langle} {\langle} 1 ,\, 2 ,\, 3
 {\rangle} ,\, {\langle} {\rangle} ,\, {\langle} {\rangle} {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} \.{\land} Assert ( tower [ 3 ] \.{\neq} {\langle} 1 ,\,
 2 ,\, 3 {\rangle} ,\,}%
\@x{\@s{83.52}\@w{Failure\ of\ assertion\ at\ line\ 13,\ column\ 3.} )}%
 \@x{\@s{39.83} \.{\land} \E\, from \.{\in} \{ x \.{\in} D \.{:} tower [ x ]
 \.{\neq} {\langle} {\rangle} \} \.{:}}%
\@x{\@s{59.14} \E\, to\@s{3.56} \.{\in} \{}%
\@x{\@s{100.52} y \.{\in} D \.{:}}%
\@x{\@s{106.26} \.{\lor} tower [ y ] \.{=} {\langle} {\rangle}}%
\@x{\@s{106.26} \.{\lor} Head ( tower [ from ] ) \.{<} Head ( tower [ y ] )}%
\@x{\@s{92.32} \} \.{:}}%
 \@x{\@s{67.34} tower \.{'} \.{=} [ tower {\EXCEPT} {\bang} [ from ] \.{=}
 Tail ( tower [ from ] ) ,\,}%
 \@x{\@s{178.22} {\bang} [ to ] \.{=} {\langle} Head ( tower [ from ] )
 {\rangle} \.{\circ} tower [ to ] ]}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Dec} 05
 17:41:22 \ensuremath{CST} 2020 by Administrator
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Dec} 05 17:40:38
 \ensuremath{CST} 2020 by Administrator
\end{cpar}%
\end{lcom}%
\end{document}
